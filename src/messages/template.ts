...
export class FlowComponent extends ButtonComponent {
     ...
     *
     * @param flow_id - Unique ID of the Flow provided by WhatsApp.
     * @param flow_token - Flow token that is generated by the business to serve as an identifier. Default is UNUSED.
    ...
    constructor(
        ...
        super(
            "flow",
            new FlowComponent.Action(flow_id, flow_token, flow_action_data)
        );
    }
